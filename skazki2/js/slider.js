;(function() {
    ...
    class Slider {
        constructor(slider, time = 3000) {
            ...
            this._allSlide = this._sliderWrapper.querySelectorAll('.slider__slide');
            ...
            this._allSlide.forEach(item => {
                item.addEventListener('mouseover', () => this.stopSlider());
                item.addEventListener('mouseout', () => this.startSlider());
            });
